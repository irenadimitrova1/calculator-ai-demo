...
3. Write the spec using the template below, then publish it to the project issue tracker. Apply the **`story`** label — this is a parent / umbrella issue, **not** directly implementable. Do **not** apply `ready-for-agent` to parent specs.
